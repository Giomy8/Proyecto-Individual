/* 
BD:
{"title": "Postre de yogurt",
"image": "https://spoonacular.com/recipeImages/715497-556x370.jpg",
"summary": "Postre de yogurt de mora fácil de preparar",
"healthScore": 12,
      "steps": [
        {
          "number": 1,
...
/*   const { recipes} = useParams();
  ...
  //const traerRecipes = useSelector((store) => store.recipes);
...
/*   const currentPage = useSelector((state) => state.currentPage);
  ...
  const handleFilter = (filterType) => {
    dispatch(filterByDiet(filterType));
    dispatch(changePage(1));
  };
